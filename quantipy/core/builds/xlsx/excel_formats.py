...
import re
from .excel_formats_constants import (
    _ATTRIBUTES,
    _DEFAULT_ATTRIBUTES,
    _VIEWS_GROUPS)
...
class _ExcelFormats(object):
    ...
    __def_attr__ = tuple(_DEFAULT_ATTRIBUTES.keys())
    __slots__ = __def_attr__ + ('default_attributes', '_view_or_group')
