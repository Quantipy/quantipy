...
#             )
    ...
    def test__has_not_any(self):
        ...
        for test_values in [[1, 3, 5], [2, 4, 6], [999]]:
            ...
            self.assertTrue(len(idx)+len(not_idx)==len(q2))
        ...
        for test_values in [[1], [1, 2], [999]]:
            ...
            self.assertTrue(len(idx.intersection(not_idx))==0)
            self.assertTrue(len(idx)+len(not_idx)==len(gender))
        ...
        for test_values in [[1], [1, 2], [999]]:
            ...
            self.assertTrue(len(idx.intersection(not_idx))==0)
            self.assertTrue(len(idx)+len(not_idx)==len(locality))
        ...
        for test_values in [[1, 3, 5], [2, 4, 6]]:
            ...
            # Test inverse index produced by not version
            not_idx_ex = _not_any(q2, test_values, True)
            self.assertTrue(len(idx.intersection(not_idx_ex))==0)
            self.assertTrue(len(idx)+len(not_idx_ex)==len(q2))
        self.assertTrue((q2.fillna(0)==q2_verify_unchanged.fillna(0)).all())
